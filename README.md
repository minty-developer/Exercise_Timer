...
수정 후에는 Render에서 `DATABASE_URL` 값을 저장하고 **Manual Deploy > Deploy latest commit**을 실행하세요. 로그에 `db.프로젝트ID.supabase.co`가 보이면 아직 Direct connection을 사용 중인 것이고, `pooler.supabase.com`이 보여야 정상입니다.
